...
\begin{center}
\leavevmode
\includegraphics[width=236pt]{classSAD_1_1Stream__AnomalyDetector_1_1CUSUM_1_1CUSUM__inherit__graph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=236pt]{classSAD_1_1Stream__AnomalyDetector_1_1CUSUM_1_1CUSUM__coll__graph}
\end{center}
\end{figure}
